...
public class PLayerWinOrTie {
    ...
    public static void isWinnerOrTie(char[][] gameboard) {// Checking if win condition has met is to check all spaces in combination are samw
